...
//
//	logger.WithFields(logger.Fields{"key1": "value1"}).Info("this is a test log")
//	logger.WithFields(logger.Fields{"key1": "value1"}).Infof("this is a test log, user_id: %d", userID)
